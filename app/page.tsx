      ...
      <main className="pt-14">
        <section className=" bg-[#00d8e3] border-b border-b-gray-400 mx-auto px-6 py-20 text-center animate-fade-in">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-2xl mx-auto mb-10 leading-relaxed">
            A clean space to track the books you love.
          </p>
          <div className="flex gap-4 justify-center items-center">
            ...
            <Link
              href="/login"
              className="px-6 py-3 text-white text-base font-medium hover:text-[#0077ed] transition-colors"
            >
              Learn more →
            </Link>
          </div>
        ...
        <section className="max-w-6xl border-b border-b-gray-400 mx-auto px-6 py-20 animate-slide-up">
          <div className="rounded-3xl p-12 md:p-16">
            <div className="grid md:grid-cols-3 gap-12">
              <div className="text-center border-r border-r-gray-400 md:text-left">
                ...
                <h3 className="text-xl font-semibold text-[#1d1d1f] mb-2">Want to Read</h3>
                <p className="text-[#86868b] leading-relaxed">Build your reading wishlist and never forget a recommendation.</p>
              </div>
              <div className="text-center border-r border-r-gray-400 md:text-left">
                <div className="w-12 h-12 bg-[#00d8e3] rounded-2xl flex items-center justify-center mb-4 mx-auto md:mx-0">
                  <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <h3 className="text-xl font-semibold text-[#1d1d1f] mb-2">Currently Reading</h3>
                <p className="text-[#86868b] leading-relaxed">Track your progress on books you're actively reading.</p>
              </div>
              <div className="text-center md:text-left">
                ...
                <h3 className="text-xl font-semibold text-[#1d1d1f] mb-2">Completed</h3>
                <p className="text-[#86868b] leading-relaxed">Celebrate your reading achievements and build your library.</p>
              </div>
            </div>
          </div>
        </section>
        ...
        <section className="max-w-5xl mx-auto px-6 py-20 text-center">
          <h2 className="text-4xl md:text-5xl font-semibold text-[#1d1d1f] mb-6">
            Track your reading for free. Get started now
          </h2>
          <Link
            href="/signup"
